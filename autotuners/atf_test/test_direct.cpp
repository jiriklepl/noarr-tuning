...
static const char *GCC_FLAGS = "-O2 -g -std=c++20 -o tmp.bin -I../../../include -I\"" STRINGIFY(ATF_HOME) "\" -DATF_HOME\"" STRINGIFY(ATF_HOME) "\" " __FILE__;
#define SPECIFIC_TUNING_BEGIN(...) NOARR_TUNE_BEGIN(noarr::tuning::atf_formatter( \
		...
		noarr::tuning::direct_run_command_builder("./tmp.bin", "../matrices 1024")))
